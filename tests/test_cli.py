...
def test_solver_same_layer_geometry_patch_uses_intent_projection_for_selection() -> None:
    ...
    assert summary["intent_repair_recommendations"][0]["role"] == "hall_lobby"
    assert summary["intent_repair_recommendations"][0]["suggested_edit_intent"]["action"] == "repair_missing_intent_role_coverage"
...
def test_apply_edit_runs_same_layer_svg_engine_without_overlay(tmp_path: Path) -> None:
    ...
    assert report["engine_report_quality"]["gates"]["crab-archi-design-same-layer-engine-report-v1"]["intent_repair_recommendations_reported"] is True
    ...
    assert report["candidate_quality"]["gate_groups"]["engine_soft"]["crab-archi-design-same-layer-engine-report-v1.intent_repair_recommendations_reported"] is True
    ...
    assert isinstance(engine_report["summary"]["intent_repair_recommendations"], list)
    ...
    assert gates["intent_repair_recommendations_reported"] is True
